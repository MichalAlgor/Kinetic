...
public enum Exponential: EasingType {
    ...
    public var timingFunction: TimingFunction {
        ...
        case .easeIn:
            fn = { (x) -> Double in
                x == 0 ? x : (10 * (x - 1)).powerOfTwo
            }
        case .easeOut:
            fn = { (x) -> Double in
                x == 1 ? x : 1 - (-10 * x).powerOfTwo
            }
        case .easeInOut:
            fn = { (x) -> Double in
                if x == 0 || x == 1 {
...
public enum Elastic: EasingType {
    ...
    public var timingFunction: TimingFunction {
        ...
        case .easeIn:
            fn = { (x) -> Double in
                (13 * Double.pi / 2 * x).sine * (10 * (x - 1)).powerOfTwo
            }
        case .easeOut:
            fn = { (x) -> Double in
